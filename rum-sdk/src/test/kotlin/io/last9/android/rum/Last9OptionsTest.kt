...
class Last9OptionsTest {
    ...
    fun `tracesEndpoint appends correct path to baseUrl`() {
        val options = Last9Options().apply {
            token = "tok"
            serviceName = "my-app"
            baseUrl = "https://otlp.example.com/v1/otlp/organizations/myorg"
        }
        assertEquals(
            "https://otlp.example.com/v1/otlp/organizations/myorg/telemetry/beacon/v1/traces",
    ...
    fun `toString includes serviceName and baseUrl`() {
        ...
        val str = options.toString()
        assertTrue(str.contains("serviceName=my-android-app"))
